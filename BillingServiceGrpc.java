package com.pm.billing;

import static io.grpc.MethodDescriptor.generateFullMethodName;

/**
 * <pre>
 * The request message containing the billing account details.
 * </pre>
 */
...
public final class BillingServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.pm.billing.BillingRequest,
      com.pm.billing.BillingResponse> getCreateBillingAccountMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CreateBillingAccount",
      requestType = com.pm.billing.BillingRequest.class,
      responseType = com.pm.billing.BillingResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.pm.billing.BillingRequest,
      com.pm.billing.BillingResponse> getCreateBillingAccountMethod() {
    io.grpc.MethodDescriptor<com.pm.billing.BillingRequest, com.pm.billing.BillingResponse> getCreateBillingAccountMethod;
      ...
      synchronized (BillingServiceGrpc.class) {
        if ((getCreateBillingAccountMethod = BillingServiceGrpc.getCreateBillingAccountMethod) == null) {
          BillingServiceGrpc.getCreateBillingAccountMethod = getCreateBillingAccountMethod =
              io.grpc.MethodDescriptor.<com.pm.billing.BillingRequest, com.pm.billing.BillingResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateBillingAccount"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.pm.billing.BillingRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.pm.billing.BillingResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     * <pre>
     * Creates a new billing account with the provided patient details and returns the account ID and status.
     * </pre>
     */
    default void createBillingAccount(com.pm.billing.BillingRequest request,
        io.grpc.stub.StreamObserver<com.pm.billing.BillingResponse> responseObserver) {
  ...
  public static final class BillingServiceStub
     ...
     * </pre>
     */
    public void createBillingAccount(com.pm.billing.BillingRequest request,
        io.grpc.stub.StreamObserver<com.pm.billing.BillingResponse> responseObserver) {
  ...
  public static final class BillingServiceBlockingStub
     ...
     * </pre>
     */
    public com.pm.billing.BillingResponse createBillingAccount(com.pm.billing.BillingRequest request) {
  ...
  public static final class BillingServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.pm.billing.BillingResponse> createBillingAccount(
        com.pm.billing.BillingRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_BILLING_ACCOUNT:
          serviceImpl.createBillingAccount((com.pm.billing.BillingRequest) request,
              (io.grpc.stub.StreamObserver<com.pm.billing.BillingResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.pm.billing.BillingRequest,
              com.pm.billing.BillingResponse>(
  ...
  private static abstract class BillingServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.pm.billing.BillingServiceOuterClass.getDescriptor();
    }
